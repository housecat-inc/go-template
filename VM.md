...
If a private repo, pass the VM the repo URL, `gh-app` script and a private key. Example:

https://github.com/housecat-inc/private

App `/usr/local/bin/gh-app` script:
...
PEM_FILE="${GH_APP_PEM:-$HOME/.ssh/shelley-agent.pem}"
REPO="${GH_APP_REPO:-}"
